...
\caption[L’architecture encoder-decoder]{L’architecture encoder-decoder} % The text in the square bracket is the caption for the list of figures while the text in the curly brackets is the figure caption
...
\begin{figure}[htb]
\centering 
\includegraphics[width=0.2\columnwidth]{data_augmentation} 
...
\caption[Factory Pattern et Data Generator]{Utilisation de pattern Factory et Command pour le DataGenerator} % The text in the square bracket is the caption for the list of figures while the text in the curly brackets is the figure caption
\label{fig:data_augmentation} 
\end{figure}
